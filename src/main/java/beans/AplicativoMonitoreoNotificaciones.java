...
public class AplicativoMonitoreoNotificaciones {
	...
	public static void main(String[] args) {
		...
		try {
			...
			try (FileReader fr = new FileReader(fileUrlsEfv)) {
				...
				String token = "EAADsQKlicEMBOwIphj8FSivtEGRrdtK1COywvr2gORZCZCGZAs3wX9KMyUdeWDxQ0qJiOvx1GcLvoZC5QWe4FEAAEbQRAmenDPSqAMZCuutP1tWKl82rfcs1808CTaSZBlbYZADejZC9jDYvp1SRrwr84IvXZB05pDB1hKuT0cnWhIZCLQZBtIeUNo3e0t5bAuV9dSFs3OzwaVfTYFtagYUuip1ClsB7AcZByd7paxYZD";
